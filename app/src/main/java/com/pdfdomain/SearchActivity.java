...
public class SearchActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void loadJSON(final int page){
        ...
        ApiClient.getInstance().getRandomBooks(String.valueOf(page)).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    if(page==0) Snackbar.make(findViewById(R.id.mylayout), response.body().length()+"+ results found for your query", Snackbar.LENGTH_LONG).show();
